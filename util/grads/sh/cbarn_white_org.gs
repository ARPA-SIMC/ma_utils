...
* Enrico, 16/01/2007
* Modificata per risolvere il problema delle labels tagliate nelle mappe
* su area BPA: adesso chiama cbarn_col e mette la legenda sempre in basso;
* per chiamare lo script originale, usare cbarn_white -org.
* Le opzioni originarie non sono piu' attive.
*

function colorbar (args)

* Inizio modifiche enr 20070116
...
if(option!='org')
  'cbarn_col 0 0 1 0 5.5 0.3'
  return
else

* Fine modifiche enr 20070116 (tranne endif a fine file)
