function defcol(args)

if(args="");args=0;endif
...
'set rgb 82 224 224 224'
'set rgb 83 192 192 192'
'set rgb 84 160 160 160'
...
*HEX: 0000FF 008D71 1CFF00 A9FF00 FFEB00
*     FFB900 FF6E00 FF1200 D40E6A A020F0
'set rgb 90    0     0  255'
'set rgb 91    0   141  113'
'set rgb 92   28   255    0'
'set rgb 93  169   255    0'
'set rgb 94  255   235    0'
'set rgb 95  255   185    0'
'set rgb 96  255   110    0'
'set rgb 97  255    18    0'
'set rgb 98  212    14  106'
'set rgb 99  160    32  240'

if(args=1)
*
*white to red
'set rgb 21  255  200  200'
'set rgb 22  255  150  150'
'set rgb 23  255  100  100'
'set rgb 24  255   50   50'
'set rgb 25  255    0    0'
'set rgb 26  205    0    0'
'set rgb 27  155    0    0'
'set rgb 28  105    0    0'
...
*
*white to green
'set rgb 31  200  255  200'
'set rgb 32  150  255  150'
'set rgb 33  100  255  100'
'set rgb 34   50  255   50'
'set rgb 35    0  255    0'
'set rgb 36    0  205    0'
'set rgb 37    0  155    0'
'set rgb 38    0  105    0'
...
*
*white to blue
'set rgb 41  200  200  255'
'set rgb 42  150  150  255'
'set rgb 43  100  100  255'
'set rgb 44   50   50  255'
'set rgb 45    0    0  255'
'set rgb 46    0    0  205'
'set rgb 47    0    0  155'
'set rgb 48    0    0  105'
