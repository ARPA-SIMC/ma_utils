...
! 01/12/2015: appurato che ora le flag di validaizone manuali nflagas_man)
!             sono solo 4 (e non 5); difficile dire se era un errore o se
!             il sginificato delle flags e' cambiato nel tempo.
!
!                                        V1.6.1, Johnny&Enrico 01/12/2015
!________________________________________________________________________
!
PROGRAM ordina
  !--------------------------------------------------------------------------
