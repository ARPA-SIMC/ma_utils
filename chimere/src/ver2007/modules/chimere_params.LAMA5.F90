module chimere_params
  ...
  integer,parameter :: nzonal    = 212 ! Number of zonal cells
  integer,parameter :: nmerid    = 233 ! Number of meridional cells
  integer,parameter :: nsho      = 1 ! Cell for screen display (NSHO<=NHORIZ)
