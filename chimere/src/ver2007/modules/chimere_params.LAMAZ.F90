module chimere_params
  ...
  ! A-0: Domain
  character(len=*),parameter :: domain ='LAMAZ'
  ...
  integer,parameter :: nzonal    = 169 ! Number of zonal cells
  integer,parameter :: nmerid    = 181 ! Number of meridional cells
  integer,parameter :: nsho      = 15463 ! Cell for screen display (NSHO<=NHORIZ)
