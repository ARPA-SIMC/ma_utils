...
!tolto    if(topcld.gt.d_hght(izo,ime)) then
!tolto       !enr5
!tolto       if(opt%cldmix.eq.1) then
!     write(6,*)'corr enr5 hgt'
!tolto       else if(opt%cldmix.eq.0) then
!tolto          d_hght(izo,ime) = (1.-topcldw)*d_hght(izo,ime) + topcldw*topcld
!tolto       endif
!tolto       !enr5
!tolto    end if
...
!tolta    if(obuklen.lt.-1.e4) obuklen=-1.e4
!tolta    if(obuklen.gt.1.e4) obuklen=1.e4
!tolta    if(obuklen.gt.0.and.obuklen.lt.umomin.and.fland(izo,ime,5).ge.uframin) obuklen=umomin
    !enr4   
...
!tolto    if(fland(izo,ime,5).ge.uframin) then
!         write(6,*)'corr enr4'
